...
class AdminServiceTest {
	...
	/*
     * Testing for updateUser service
     */
	   @Test
	   void testUpdateUser()  
	   {
		   UserDTO u1 = userDetails();
			...
			catch(UserNotFoundException | NullPointerException | SignUpExceptions e) { }
	   }


	   /*
	    * Testing for listAllUser service
	    */ 
	   @Test
	   ...
	   /*
	    * Testing for deleteUser service
	    */ 
	   @Test
	   ...
	   /*
	    * Testing for deleteUser service when it throws an exception
	    */ 
	   @Test
	   ...
	   /*
	    * Testing for updateUser service when it throws an exception
	    */ 
	   @Test
	   void testExceptionUpdateUser()  
	   {
		   ...
		   Mockito.when(repo.save(u2)).thenReturn(u2);
			  ...
			  catch(UserNotFoundException | SignUpExceptions e){ assertEquals(s1,(e.getMessage()));}
	   }
	    ...
	    */ 
	   @Test
	   void testExceptionDeleteUser1()  
	   {
		   UserDTO u1 = userDetails();
		   User u2 = LoginUtils.convertTouser(u1);
		   Mockito.when(repo.save(u2)).thenReturn(u2);
			  String s1 = "User not available ,Delete operation failed";
			  try { adminService.deleteUser("kannan758@gmail.com","admin");}
			  catch(UserNotFoundException e){ assertEquals(s1,(e.getMessage()));}
	   }
}
