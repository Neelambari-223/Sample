...
class LoginRepositoryTest {
	...
	/*
     * Test for checking the Repository by the login service
     */
	@Test
	 void testlogin() {
		User user=getuser();
	...
	/*
     * Test for checking the Repository by the register service
     */
	@Test
	 void testregister() {
		User user=getuser();
	...
	/*
     * Test for checking the Repository by the admin login service
     */
	 @Test
	 void testAdminlogin()
	 {
	 ...
	 /* 
	  * Test for checking the Repository by the addUser service
      */
	 @Test
	 void testAddUser()
	 {
	 ...
	 /*  
	  * Test for checking the Repository by the updateUser service
      */
	 @Test
	 void testUpdateUser()
	 {
	 ...
	 /*
	  * Test for checking the Repository by the listAllUser service
      */
	 @Test 
	 ...
	 /* 
	  * Test for checking the Repository by the listUser service
      */   
	 @Test
	 void testListUser()
	 {
	 ...
	 /* 
	  * Test for checking the Repository by the deleteUser service
      */   
	 @Test
	 void testDeleteUser()
	 {
